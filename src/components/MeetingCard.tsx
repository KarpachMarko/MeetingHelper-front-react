                    ...
                    <svg className="absolute top-0 right-0" width="158" height="119" aria-hidden="true">
                        <defs>
                            <linearGradient x1="50%" y1="0%" x2="50%" y2="96.22%" id="a">
                                <stop stopColor="#aeecff" stopOpacity=".88" offset="0%"/>
                                <stop stopColor="#aeecff" stopOpacity=".24" offset="100%"/>
                            </linearGradient>
                        </defs>
                        <g transform="translate(-719 -96)" stroke="url(#a)" fill="none" fillRule="evenodd">
                            <path
                            ...
                            <ArcherContainer style={{width: "100%", height: "100%"}} strokeColor="#FFF">
                                <ArcherElement id="1" relations={[{
                                    ...
                                    <div className="absolute top-6 left-0 bg-indigo-100 rounded-full drop-shadow-2xl">
                                        <span
                                            className="px-4 py-2 text-xl text-indigo-500 font-bold">{`${startDate.getDate()}.${startDate.getMonth() + 1}`}</span>
                                    </div>
                                </ArcherElement>
