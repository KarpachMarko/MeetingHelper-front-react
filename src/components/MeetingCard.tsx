			...
			<div className="h-full">
				...
				<div className="max-w-xs mx-auto">
					<div className="relative bg-indigo-400 shadow-lg rounded-lg shadow-xl p-5 overflow-hidden">
						...
						<div className="absolute inline-flex items-center justify-center overflow-hidden rounded-full top-0 right-0">
						...
						<div className="absolute top-5 right-[5rem] bg-white rounded-full drop-shadow-xl">
							<span className="px-4 py-2 text-2xl text-indigo-500 font-bold">{300 * percent / 100}/300 $</span>
						</div>
						...
						<div className="relative pt-[6.25rem] pb-14 drop-shadow-2xl">
							...
							<p className="text-indigo-200">
								Description Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias error excepturi sint. Aliquam dolore ea eum facere nemo officiis sapiente!
							</p>
							...
							<div className="relative mt-5 h-24">
								...
								<ArcherContainer style={{width: "100%", height: "100%"}} strokeColor="#FFF">
										<ArcherElement id="1" relations={[{targetId: "2", sourceAnchor:"bottom", targetAnchor:"left"}]}>
										...
										<ArcherElement id="2">
											<div className="absolute bottom-0 right-8 bg-indigo-50 rounded-full drop-shadow-2xl">
